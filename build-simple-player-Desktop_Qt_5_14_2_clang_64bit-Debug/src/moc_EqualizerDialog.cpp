...
QT_INIT_METAOBJECT const QMetaObject EqualizerDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_EqualizerDialog.data,
    qt_meta_data_EqualizerDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *EqualizerDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::EqualizerDialog"))
        return static_cast< Ui::EqualizerDialog*>(this);
